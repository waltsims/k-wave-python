...
from kwave_py import kWaveGrid
from kwave_py.ksource import kSource
from kwave_py.utils import matlab_mask
...
def check_conditions(is_nonuniform_grid, is_source_uy, is_source_uz, is_transducer_source):
    ...
    if is_nonuniform_grid and (is_source_uy or is_source_uz or is_transducer_source):
        warn('WARNING: source scaling not implemented for non-uniform grids with given source condition')
        return False
    return True
