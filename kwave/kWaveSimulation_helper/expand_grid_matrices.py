...
def print_grid_size(kgrid):
    ...
    if kgrid.dim == 1:
        logging.log(logging.INFO, f"  computational grid size: {int(k_Nx)} grid points")
    elif kgrid.dim == 2:
        logging.log(logging.INFO, f"  computational grid size: {int(k_Nx)} by {int(k_Ny)} grid points")
    elif kgrid.dim == 3:
        logging.log(logging.INFO, f"  computational grid size: {int(k_Nx)} by {int(k_Ny)} by {int(k_Nz)} grid points")
