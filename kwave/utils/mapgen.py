...
@beartype
def make_circle(
    grid_size: Vector, center: Vector, radius: Real, arc_angle: Optional[float] = None, plot_circle: bool = False
) -> kt.NP_ARRAY_INT_2D:
    """
...
@beartype
def make_arc(
    grid_size: Vector, arc_pos: np.ndarray, radius: Real, diameter: Int, focus_pos: Vector
