...
for dim=dims
    ...
    switch dim
        case 1
            ...
            mask_points_x = uint8(utils.rand_vector_in_range(1, data_dim(1)-1, num_pts_per_dim));
        ...
        case 2
            ...
            mask_points_x = uint8(utils.rand_vector_in_range(1, data_dim(1)-1, num_pts_per_dim));
            mask_points_y = uint8(utils.rand_vector_in_range(1, data_dim(2)-1, num_pts_per_dim));
        ...
        case 3
            ...
            mask_points_x = uint8(utils.rand_vector_in_range(1, data_dim(1)-1, num_pts_per_dim));
            mask_points_y = uint8(utils.rand_vector_in_range(1, data_dim(2)-1, num_pts_per_dim));
            mask_points_z = uint8(utils.rand_vector_in_range(1, data_dim(3)-1, num_pts_per_dim));
