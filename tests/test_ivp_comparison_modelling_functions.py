...
def test_ivp_comparison_modelling_functions():
    ...
    assert compare_against_ref("out_ivp_comparison_modelling_functions/input_1", input_file_full_path), "Files do not match!"
    ...
    assert compare_against_ref("out_ivp_comparison_modelling_functions/input_2", input_file_full_path), "Files do not match!"
